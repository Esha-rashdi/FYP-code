  ...
  return (
    <section className="pricing">
      <div className="pricing__heading-section">
        <h3 className="h3 pricing__heading">Start Saving Development Time Today</h3>
        <p className="text-reg pricing__subheading">
          Choose Perfect Plan for your needs, With lots of unique blocks, you can easily build a page without
